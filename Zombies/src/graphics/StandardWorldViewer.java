 ...
 */
public class StandardWorldViewer extends GridGraphics
{
    //-------------------------------------------------
    //constants
     ...
     */
    public StandardWorldViewer(int numRows, int numCols)
    {
     ...
     */
    public StandardWorldViewer(int numRows, int numCols, int frameWidth,
        int frameHeight)
    {
